...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="mynavbar">
                           ...
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                  <a href="products.php" class="dropdown-item">All Products</a>
                                   ...
                                   <a href="headphones.php" class="dropdown-item">Headphones/Speakers</a>
                               </div>
                    ...
                    <input id="searchInput" class="form-control form-control-sm mr-sm-2" type="search" placeholder="Search" aria-label="Search">
               <button class="btn btn-outline-light btn-sm my-2 my-sm-0" type="button" onclick="searchProducts()">Search</button>
                      </form>
